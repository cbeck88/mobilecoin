...
use mc_transaction_core::{
    ...
    Amount, AmountData, Block, BlockContents, BlockSignature, MemoPayload, TokenId, BLOCK_VERSION,
};
use prost::Message;
...
impl ConsensusEnclave for SgxConsensusEnclave {
    ...
    fn form_block(
        ...
        // TODO: This should probably be constant time with respect to token id
