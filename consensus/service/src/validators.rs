...
mod combine_tests {
    ...
    fn combine_reject_duplicate_output_public_key() {
        ...
        for block_version in 1..3 {
            ...
            .unwrap();
            if block_version < 2 {
                tx_out1.amount.masked_token_id = Default::default();
            }

            let mut tx_out2 = TxOut::new(
                123,
                Mob::ID,
                &alice.default_subaddress(),
                &RistrettoPrivate::from_random(&mut rng),
            ...
            .unwrap();
            if block_version < 2 {
                tx_out2.amount.masked_token_id = Default::default();
            }
